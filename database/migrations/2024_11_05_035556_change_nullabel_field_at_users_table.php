...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adddres_one')->nullable()->change();
            $table->longText('adddres_two')->nullable()->change();
    ...
    {
        Schema::table('users', function (Blueprint $table) {
            $table->longText('adddres_one')->nullable(false)->change();
            $table->longText('adddres_two')->nullable(false)->change();
